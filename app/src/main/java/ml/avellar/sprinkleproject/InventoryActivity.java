...
public class InventoryActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_about) {
            startActivity(new Intent(InventoryActivity.this, AboutActivity.class));
        } else if (id == R.id.nav_inventory) {
            startActivity(new Intent(InventoryActivity.this, InventoryActivity.class));
            this.finish();
        } else if (id == R.id.nav_map) {
            startActivity(new Intent(InventoryActivity.this, LocationActivity.class));
        } else if (id == R.id.nav_notification) {
            startActivity(new Intent(InventoryActivity.this, NotificationActivity.class));
            this.finish();
